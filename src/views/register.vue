<script setup>
import { ref } from "vue";
import { useRegisterStore,useLoginStore } from "@/stores/auth";
...
const register = () => {
  ...
  authRegister.registerFirebase(email.value, password.value);
};
</script>
...
<template>
  <div class="content">
    ...
    <div
      ...
      :class="continueForm ? 'h-56' : 'h-[26rem]'"
    >
      <transition name="fade" mode="out-in">
          ...
          <div class="content__middle">
            <div class="content__middle__top">
              ...
              <div class="content__middle__top__middle">
                <div
                  class="content__middle__top__middle__line"
                  aria-hidden="true"
                >
                  <div />
                </div>
          ...
          <div class="content__bottom">
            ...
            <div class="content__bottom__bottom">
              <p>
                ...
                <router-link to="/login" as="a">Sign in</router-link>
              </p>
            </div>
          </div>
        </div>
        <div v-else class="content__continueForm">
          <div class="pt-2">
            <button
              @click="continueForm = false"
              class="mb-5 text-gray-500 hover:text-gray-600"
            >
